...
class %BOOTCODE%_lessc {
	...
	protected function injectVariables($args) {
		$this->pushEnv();
		$parser = new %BOOTCODE%_lessc_parser($this, __METHOD__);
...
class %BOOTCODE%_lessc_parser {
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode("|",
			array_map(array("%BOOTCODE%_lessc", "preg_quote"), $directives));
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("%BOOTCODE%_lessc", "preg_quote"), $stop);
...
class %BOOTCODE%_lessc_formatter_classic {
	public $indentChar = "  ";
...
class %BOOTCODE%_lessc_formatter_compressed extends %BOOTCODE%_lessc_formatter_classic {
...
class %BOOTCODE%_lessc_formatter_lessjs extends %BOOTCODE%_lessc_formatter_classic {
	public $disableSingle = true;
